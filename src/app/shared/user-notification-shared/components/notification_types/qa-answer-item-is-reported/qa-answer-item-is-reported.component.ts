...
@Component({
  selector: 'app-qa-answer-item-is-reported',
  templateUrl: './qa-answer-item-is-reported.component.html',
  styleUrls: ['./qa-answer-item-is-reported.component.scss']
})
export class QAAnswerItemIsReportedComponent implements OnInit {
