...
@Component({
  selector: 'app-qa-question-item-reporter-is-punished',
  templateUrl: './qa-question-item-reporter-is-punished.component.html',
  styleUrls: ['./qa-question-item-reporter-is-punished.component.scss']
})
export class QAQuestionItemReporterIsPunishedComponent implements OnInit {
  ...
  openDialog(): void {
    ...
    if (foundItem) {
      const dialogRef = this.dialog.open(ControlReportQAQuestionComponent, {
        ...
        data: {
          QA_Item: foundItem,
          noti_type: 'questionReporter_isPunished',
