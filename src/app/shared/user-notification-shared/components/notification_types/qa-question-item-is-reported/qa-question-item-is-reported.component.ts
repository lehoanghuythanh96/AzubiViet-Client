...
@Component({
  selector: 'app-qa-question-item-is-reported',
  templateUrl: './qa-question-item-is-reported.component.html',
  styleUrls: ['./qa-question-item-is-reported.component.scss']
})
export class QAQuestionItemIsReportedComponent implements OnInit {
