...
@Component({
  selector: 'app-report-invalid-qa-answer-dialog',
  templateUrl: './report-invalid-qa-answer-dialog.component.html',
  styleUrls: ['./report-invalid-qa-answer-dialog.component.scss']
})
export class ReportInvalidQAAnswerDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private store: Store,
    private dialogRef: MatDialogRef<ReportInvalidQAAnswerDialogComponent>
  ) { }
  ...
  confirmReport() {
    ...
    if (confirm("Are you sure you want to report this answer?")) {
      ...
      let _payload: postAPI = {
        urlsuffix: 'report_invalid_QA_Answer',
        body: _body
      }
